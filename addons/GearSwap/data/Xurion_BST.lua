...
function init_gear_sets()
    ...
    sets.precast.JA['Spur'] = {
        feet="Ferine Ocreae +1" --enhances spur effect, need to get +2
    }
    ...
    -- CURING WALTZ
    sets.precast.Waltz = {
        neck="Ferine Necklace" --double check this
    }
    ...
    -- IDLE SET
    sets.idle = {
        neck="Wiglen Gorget", -- damage taken -6% and regen
        ear1="Sabong Earring", -- pet double attack +2%
        waist="Moepapa Stone", -- pet haste +5%
        legs="Ferine Quijotes +1" -- pet damage taken -2%. +2 version does the same.
    }
